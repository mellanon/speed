...
--
-- Värd: localhost:3306
-- Tid vid skapande: 20 aug 2015 kl 16:35
...
-- Databas: `speedtest`
--
CREATE DATABASE IF NOT EXISTS `speedtest` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `speedtest`;
...
--
-- Index för tabell `request`
--
ALTER TABLE `request`
  ADD PRIMARY KEY (`rqid`);

--
-- Index för tabell `request_history`
--
ALTER TABLE `request_history`
  ADD PRIMARY KEY (`rqhid`);

--
-- Index för tabell `request_status`
--
...
--
-- AUTO_INCREMENT för tabell `request`
--
ALTER TABLE `request`
  MODIFY `rqid` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT för tabell `request_history`
--
ALTER TABLE `request_history`
  MODIFY `rqhid` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT för tabell `request_status`
--
ALTER TABLE `request_status`
